...
export namespace TOM {
    export class Dog { eat() { console.log('TOM dog'); } }
}
export namespace home {
    export class Dog { eat() { console.log('My dog'); } }
}
let TOM_dog = new TOM.Dog();
TOM_dog.eat();
let home_dog = new home.Dog();
home_dog.eat();
...
declare const $2: (selector: string) => { //变量
    click(): void;
